    ...
    const renderLogoItem = useCallback(
      (item, key) => {
        ...
        const content = isNodeItem ? (
          <span
            className={cx(
              'inline-flex items-center opacity-30',
              'motion-reduce:transition-none',
              scaleOnHover &&
                'transition-transform duration-300 ease-in-out group-hover/item:opacity-100 group-hover/item:text-(--third) group-hover/item:scale-120'
            )}
